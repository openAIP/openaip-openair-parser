...
class DaToken extends BaseLineToken {
    ...
    isAllowedNextToken(token) {
        const { BLANK_TOKEN, COMMENT_TOKEN, DP_TOKEN, VD_TOKEN, VX_TOKEN } = this._tokenTypes;

        return [BLANK_TOKEN, COMMENT_TOKEN, DP_TOKEN, VD_TOKEN, VX_TOKEN].includes(token.constructor.type);
    }
